...
<?php if (CheckIfUserCan($_SESSION['user']['id'], 'edit_vehicles')): ?>
...
<table border="1">
    ...
    <?php
    $show = false;
    if (CheckIfUserCan($_SESSION['user']['id'], 'view_vehicles')) {
        $show = true;
    }
    ...
    if ($show) {
        ...
        echo "Je hebt geen toestemming om de autolijst in te kijken.";
    }
    ?>

    <?php if (CheckIfUserCan($_SESSION['user']['id'], 'role_permissions')): ?>
        <a href="admin.php">+ Accounts beheren</a>
    <?php endif; ?>
